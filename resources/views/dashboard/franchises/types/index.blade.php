                                        ...
                                        <td>
                                            <div class="d-flex justify-content-end">
                                                <div class="btn-group-sm">
                                                    <a href="@route('dashboard.franchises.types.edit', $type)" data-ajax-form="true" class="btn btn-primary">
                                                        <i class="fal fa-fw fa-pen"></i>
                                                    </a>
                                                    <a href="javascript:void(0)" class="btn btn-danger" onclick="if (confirm('@lang('Confirm Delete')')) $('form#destroy_{{ $type->id }}').submit();">
                                                        <i class="fal fa-fw fa-trash"></i>
                                                    </a>
                                                </div>
                                                <form action="@route('dashboard.franchises.types.destroy', $type)" method="POST" id="destroy_{{ $type->id }}">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </div>
